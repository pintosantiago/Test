...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Hypechat.WorkspacesApi();
  });
  ...
  describe('WorkspacesApi', function() {
    describe('apiWorkspacesPost', function() {
      it('should call apiWorkspacesPost successfully', function(done) {
        //uncomment below and update the code to test apiWorkspacesPost
        //instance.apiWorkspacesPost(function(error) {
