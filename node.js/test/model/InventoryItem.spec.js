...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.HypeChatApi);
  }
}(this, function(expect, HypeChatApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new HypeChatApi.InventoryItem();
  });
  ...
  describe('InventoryItem', function() {
    it('should create an instance of InventoryItem', function() {
      ...
      //var instance = new HypeChatApi.InventoryItem();
      //expect(instance).to.be.a(HypeChatApi.InventoryItem);
    });
